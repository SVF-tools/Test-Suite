...
void *foo(void *x) {
  ...
  INTERLEV_ACCESS(2,"cs1.Call,cs2.foo1,cs4.foo","0,1,2,3,4");  
  INTERLEV_ACCESS(4,"cs1.Call,cs6.foo2,cs5.foo","0,3,4,1,2");  
  return x;
}
...
void *foo1(void *x) {
  ...
  INTERLEV_ACCESS(1,"cs1.Call,cs2.foo1","0,1,3,4");  

cs4: pthread_create(&t2, NULL, foo, NULL);

     Global ++;
     INTERLEV_ACCESS(1,"cs1.Call,cs2.foo1","0,1,2,3,4");  
...
void *foo2(void *x) {
  ...
  Global ++;
  INTERLEV_ACCESS(3,"cs1.Call,cs6.foo2","0,3,2,1");  

cs5: pthread_create(&t4, NULL, foo, NULL);

     Global ++;
     INTERLEV_ACCESS(3,"cs1.Call,cs6.foo2","0,3,4,1,2");  
